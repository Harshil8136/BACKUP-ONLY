 ...
 *
 * UPDATED: The `displayBiller` function's `createContactField` helper has
 * been upgraded to render a special warning note for any contact that has
 * a `note` property in the data file.
 */
