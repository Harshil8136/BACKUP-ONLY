 ...
 *
 * UPDATED: The `displayBiller` function now calls the new animation utility
 * (`Anim.enterCard`) to apply a subtle entrance animation.
 */
...
const UI = {
  ...
  displayBiller: function(biller) {
    ...
    // --- NEW: Hook for the entrance animation ---
    // This safely calls the animation utility after the card is rendered.
    if (window.Anim) {
